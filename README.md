...
1. Move into tinyccBUGGED: ```cd tinyccBUGGED```
2. Compile the infected binary to make compiler A: ```./configure && make clean && make```
3. Move A into the clean source and follow it: ```mv ./tcc ../tinycc/tccBUGGED && cd ../tinycc```
